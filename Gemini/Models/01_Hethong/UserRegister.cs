...
namespace Gemini.Models._01_Hethong
{
    public class UserRegister
    {
        ...
        [Required(ErrorMessageResourceType = typeof(Resources.Resource), ErrorMessageResourceName = "RequiredFill")]
        [RegularExpression(@"^(\(?\+?[0-9]*\)?)?[0-9_\- \(\)]*$", ErrorMessageResourceType = typeof(Resources.Resource), ErrorMessageResourceName = "RegularEmailFill")]
        [Display(Name = "Nsd_Mobile", ResourceType = typeof(Resources.Resource))]
