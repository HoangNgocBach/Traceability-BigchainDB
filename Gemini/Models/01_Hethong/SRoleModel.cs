...
namespace Gemini.Models._01_Hethong
{
    public class SRoleModel
    {
        ...
        public SRoleModel(SRole sRole)
        {
            ...
            IsManufacturing = sRole.IsManufacturing.GetValueOrDefault(false);
            IsTransport = sRole.IsTransport.GetValueOrDefault(false);
            IsDistribute = sRole.IsDistribute.GetValueOrDefault(false);
            IsAccreditation = sRole.IsAccreditation.GetValueOrDefault(false);
            Note = sRole.Note;
        ...
        public void Setvalue(SRole sRole)
        {
            ...
            sRole.IsManufacturing = IsManufacturing;
            sRole.IsTransport = IsTransport;
            sRole.IsDistribute = IsDistribute;
            sRole.IsAccreditation = IsAccreditation;
            sRole.Note = Note;
